...
// 사람 데이터 목록 선언
const saramList = [
    {no:102, name:'홍길동', email:'hong@saram.com', job:'도둑',age:'10'},
    {no:101, name:'이길동', email:'lee@saram.com', job:'변호사',age:'50'},
    {no:103, name:'김길순', email:'kim@saram.com', job:'프로그래머',age:'24'},
    {no:104, name:'박길순', email:'park@saram.com', job:'군인',age:'30'}
];
